      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="rounded-3xl bg-gradient-to-tr from-emerald-950 to-emerald-850 text-white p-8 md:p-12 grid gap-8 md:grid-cols-2 items-center relative overflow-hidden">
          ...
          <div className="rounded-2xl overflow-hidden shadow-2xl border border-white/10 aspect-[4/3] bg-emerald-900/40 relative">
            <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&q=80&w=600" alt="Meditation" className="h-full w-full object-cover mix-blend-overlay" referrerPolicy="no-referrer" />
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="flex h-14 w-14 items-center justify-center rounded-full bg-amber-400 text-emerald-950 shadow-md">
